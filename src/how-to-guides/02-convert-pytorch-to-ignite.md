...
We use a built-in wrapper around `tqdm` called [`ProgressBar()`](https://pytorch.org/ignite/generated/ignite.handlers.tqdm_logger.html#ignite.handlers.tqdm_logger.ProgressBar).
